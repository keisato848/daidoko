...
const recipeImport: typeof ja = {
  ...
  consult: {
    ...
    meta: {
      separator: ' · ',
      servings: { one: '{{count}} serving', other: '{{count}} servings' },
      minutes: { one: '{{count}} min', other: '{{count}} min' },
      ingredients: { one: '{{count}} ingredient', other: '{{count}} ingredients' },
    ...
    change: {
      ...
      servingsCleared: 'servings unset',
      minutes: { one: 'now {{count}} min', other: 'now {{count}} min' },
      minutesCleared: 'cook time unset',
      added: 'added {{name}}',
      removed: 'removed {{name}}',
      adjusted: { one: 'adjusted {{count}} ingredient', other: 'adjusted {{count}} ingredients' },
      stepsCount: { one: 'now {{count}} step', other: 'now {{count}} steps' },
      stepsEdited: { one: '{{count}} step edited', other: '{{count}} steps edited' },
