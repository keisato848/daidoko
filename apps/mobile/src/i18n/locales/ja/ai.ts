...
const ai = {
  ...
  error: {
    ...
    /**
     * HTTP ステータス→文言は ai-error.ts の共通マッパーで変換する（水平展開規約・
     * 2026-09-05）。serverError は 404 等、他のどれにも当たらないときの最後の砦。
     */
    serverError: 'サーバーエラー ({{status}})',
    /** 400/413。実機のカメラ写真がサーバーの上限を超えたときが典型 */
    tooLarge:
      '送信した写真やデータが大きすぎました。写真を撮り直すか、内容を減らしてお試しください。',
    /** 429（共有レート上限）。時間経過で直る */
    busy: '混み合っています。時間をおいてお試しください。',
    /** 5xx。サーバー側の問題で、利用者にできるのは待つことだけ */
    serverDown: 'サーバーで問題が発生しました。時間をおいてお試しください。',
