...
const home = {
  ...
  /** 初回利用ガイド（コーチマーク）。 */
  coach: {
    addTitle: '記録もレシピもここから',
    addText:
      '作った料理の記録やレシピの追加は、下の「追加」タブから始めます。「料理の写真を撮る」「AIと相談しながらつくる」のほか、URL取り込み・手入力もここからできます。',
    // #219 で買い物をボトムタブへ出し、空いた枠に設定を置いた。**指す先が変わったのに
    // 文言だけ残り、設定の歯車をハイライトして「このカートから」と言っていた**（〜1.12.2）。
    // 買い物・在庫はタブに実物があるので、ここでは設定の移動だけを伝える
    settingsTitle: '設定はここ',
    settingsText: 'バックアップ・家族との共有・使い方は、この歯車から開けます。',
  },
};
