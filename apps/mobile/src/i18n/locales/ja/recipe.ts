...
const recipe = {
  ...
  photo: {
    ...
    // 旧「使い放題にする」は**押した先が読めず全ペルソナがためらった**
    // （docs/reviews/persona/1.12.2.md #1）。実態（枠切れ→広告視聴でその場続行・
    // BYOK なら使い放題 — フリーミアム設計 §7-3）をそのまま予告する。
    quotaHint: '使い切ったら広告を見て追加 ・ 自分のAIキーで使い放題',
