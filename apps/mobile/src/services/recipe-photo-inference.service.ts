...
const PROFILES: RecipePhotoProfile[] = [
  {
    ...
    title: '写真から推測したカレー',
    description: '写真の色味と盛り付けから推測したカレー風の下書きです。',
    tags: ['推測', 'カレー'],
  ...
  },
  {
    ...
    title: '写真から推測したパスタ',
    description: '麺料理として推測した下書きです。ソースや具材は写真を見て調整してください。',
    tags: ['推測', '麺'],
  ...
  },
  {
    ...
    title: '写真から推測したサラダ',
    description: '野菜中心の料理として推測した下書きです。',
    tags: ['推測', '野菜'],
  ...
  },
  {
    ...
    title: '写真から推測したごはん料理',
    description: 'ごはんを使った料理として推測した下書きです。',
    tags: ['推測', 'ごはん'],
  ...
  },
  {
    ...
    title: '写真から推測した焼き料理',
    description: '焼いた料理または菓子として推測した下書きです。',
    tags: ['推測', '焼き料理'],
...
export function inferRecipeFromPhotoLabels(labels: ClientImageLabel[]): RecipePhotoInferenceResult {
  ...
  const selected = profile ?? {
    ...
    keywords: [],
    title: '料理写真からのレシピ案',
    description: '写真から推測した下書きです。料理名・分量・手順を確認してください。',
    tags: ['推測'],
