...
export const ROUTES = [
  ...
  },
  {
    ...
    patterns: [
      /出して(いい|良い|よい|大丈夫)|マージ(して|できる|していい)|PR (に|を)(出|作)|リリースして(いい|良い|よい)|品質|レビューして|テスト(は|が)足り/,
  ...
  },
  {
    ...
    patterns: [
      /作(りたい|ろう|るべき|る価値)|欲しい|追加したい|入れたい|どう思う|価値(は|が)ある|優先(度|順)|スコープ|ユーザー(は|に)(嬉|喜|困)|アイデア|訴求|掲載文/,
